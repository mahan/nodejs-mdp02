...
var TimeoutError = function (_Error) {
    ...
    function TimeoutError(message) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TimeoutError).call(this, message));
...
var ProtocolError = function (_Error2) {
    ...
    function ProtocolError(message) {
        ...
        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(ProtocolError).call(this, message));
