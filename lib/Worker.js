...
var ZMQWritable = function (_Writable) {
    ...
    function ZMQWritable(zmqWorker, options) {
        ...
        var _this = _possibleConstructorReturn(this, (ZMQWritable.__proto__ || Object.getPrototypeOf(ZMQWritable)).call(this, options));
    ...
    _createClass(ZMQWritable, [{
        ...
        value: function end(chunk, enc, cb) {
            ...
            _get(ZMQWritable.prototype.__proto__ || Object.getPrototypeOf(ZMQWritable.prototype), 'end', this).call(this, chunk, enc, cb);
...
var Worker = function (_EventEmitter) {
    ...
    _createClass(Worker, [{
        ...
        key: 'stop',
        value: function stop(skipDisconnectMessage) {
        ...
        value: function startHeartBeat() {
            ...
            this._hbTimer = setInterval(function () {
                if (Date.now() - _this5.heartBeatTs > _this5.timeout) {
                    _this5.stop(true);
                    _this5.start();
                } else {
                    _this5.sendingMessage || _this5._sendHeartBeat();
                }
            }, this.hbFrequence);
        }
    }, {
